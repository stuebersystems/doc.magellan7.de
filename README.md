...
1. Erstelle einen lokalen Ordner für die Dokumentation, z.B. `c:\docs\magellan`.

2. Starte die Eingabeaufforderung und wechsle in den Ordner `c:\docs\magellan`.

3. Tippe den Befehl `git clone https://github.com/stuebersystems/doc.magellan7.de.git` ein, um das Repository zu klonen.
...
1. Öffne die URL `https://github.com/stuebersystems/doc.magellan7.de` in deinem Webbrowser

2. Klicke auf die Schaltfläche `Clone or download` und dann auf `Download ZIP`.

3. Entpacke das Zip-Archiv in einen lokalen Ordner Deiner Wahl, z.B. `c:\docs\magellan`.
