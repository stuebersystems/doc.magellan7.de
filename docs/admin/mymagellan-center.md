...
3. Sie vergeben ein Passwort für mehrere Dateien, [diese Möglichkeit wird später beim Erstellen der Dateien angeboten](https://doc.magellan7.stueber.de/admin/mymagellan-center.html#karte-sicherheit-festlegen).
...
* [Zuordnung der MyMAGELLAN-Teilnehmer zu den Schülern](https://doc.magellan7.stueber.de/admin/mymagellan-center.html#zuordnung-der-mymagellan-teilnehmer-zu-den-sch%C3%BClern)
* [Organisation des zeitlichen Ablaufs](https://doc.magellan7.stueber.de/admin/mymagellan-center.html#organisation-des-zeitlichen-ablaufs)
* [Mögliche Konflikte](https://doc.magellan7.stueber.de/admin/mymagellan-center.html#m%C3%B6gliche-konflikte)
