...
![Schaltflächen in der oberen Menüleiste](/images/magellan.administrator/users_benutzer.exportieren.png)

![Die erzeugte Datei kann mit Excel geöffnet und bearbeitet werden.](/images/magellan.administrator/users_benutzer.exportieren1.png)
...
![Einen neuen MAGELLAN-Benutzer anlegen](/images/magellan.administrator/neuer.benutzer.png)
...
![Legen Sie hier die Grunddaten des Benutzers fest](/images/magellan.administrator/benutzer.anlegen.png)
...
![Legen Sie die Rechte für den Benutzer fest](/images/magellan.administrator/users_rechtekarte.png)
...
![Sie können auf dieser Karte festlegen, ob der Benutzer Noten mit MYMAGELLAN erfassen darf, ein MYMAGELLAN-Kennwort besitzt und den späteren Speicherort seiner MYMAGELLAN-Datei angeben.](/images/magellan.administrator/users_mymagkarte.png)
...
![Hier sehen Sie eine Übersichtsliste alle Teilnehmer von MYMAGELLAN.](/images/magellan.administrator/users_mymag.liste.png) 
