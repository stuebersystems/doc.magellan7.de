...
![Über die Datenmaske `Ausleihe & Rückgabe` wickeln Sie Ihre Leihvorgänge ab.](../../assets/images/ausleihe und rückgabe.png)
...
![In den Segmenten `Ausleiher` sowie `Buch/ Medien` der Datenmaske `Ausleihe & Rückgabe` werden die Daten des Ausleihers und des Medien-titels hinterlegt](../../assets/images/ausleihe und rückgabe1.png)
...
![Im Segment `Vorgang` der Datenmaske `Ausleihe & Rückgabe` wählen Sie die Aktion, die Sie mit einem Exemplar durchführen möchten, und bestätigen diese.](../../assets/images/vorgang.png)
...
![Auf der Registerkarte `Quittungen` des Dialogfensters `Optionen` stellen Sie die Berichtsdatei ein, die als Vorlage für den Quittungsdruck benutzt wird.](../../assets/images/quittungen.png)
...
![Im Dialogfenster `Aktion auswählen` treffen Sie die Entscheidung, ob ein bereits entliehenes Exemplar verlängert oder zurückgegeben werden soll](../../assets/images/aktion auswählen.png)
...
![Auf der Registerkarte `Ausleihe` des Dialogfensters `Optionen` bestimmen Sie den Ver-längerungszeitraum und die Anzahl der möglichen Verlängerungen.](../../assets/images/optionen ausleihe.png)
