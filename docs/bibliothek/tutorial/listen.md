...
![Hier wurde die Liste der Bücher/ Medien nach den Spalten `Autor` und `Kategorie` gruppiert. Der Gruppierungsbalken für den Autor Friedrich von Schiller enthält selbst wiederum zwei Gruppierungsbalken für die Kategorien `Bellet` und `Klassik`, die jeweils zu einer Teilliste aufgeklappt sind. ](../../assets/images/gruppierung1.png)
...
![Hier sehen Sie die Liste der Bücher/ Medien, die nach dem Autor `Friedrich von Schiller` gefiltert wird.](../../assets/images/filtern.png)
...
![Hier sehen Sie die Liste der Bücher/ Medien, die nach dem Autor `Friedrich von Schiller` und dem Titel `Die Räuber` gefiltert wird.](../../assets/images/filtern1.png)
...
![Hier sehen Sie das Dialogfenster `Benutzerdefinierter Filter`, in dem Sie Ihre Filterkriterien individuell anpassen können.](../../assets/images/filtern2.png)
...
![Hier wurden mithilfe der Schalfläche `Alles markieren` alle Einträge der Liste `Aktuelle Vorgänge` ausgewählt. ](../../assets/images/alles markieren.png)
...
![ Hier sehen Sie einen Ausschnitt der Seitenvorschau des Druckberichts `Medienlis-te1.rpt`, der für die Liste der Bücher/ Medien angefertigt werden kann ](../../assets/images/berichtsvorschau.png)


## Listen exportieren


Sie haben die Möglichkeit Stammdaten- und Vorgangslisten ganz oder teilweise nach Excel bzw. HTML zu exportieren. Der Export nach Excel steht für alle Listen zur Verfügung. Der HTML-Export kann hingegen nur für die Liste der `Bücher7Medien` sowie für die beiden Vorgangslisten in der Ansicht `Vorgänge` erfolgen.
...
![Hier sehen Sie einen Excel-Export der Liste `Aktuelle-Vorgänge`.](../../assets/images/excelexport.png)
...
![Hier sehen Sie einen HTML-Export der Liste `Aktuelle Vorgänge`.](../../assets/images/htmlexport.png)
