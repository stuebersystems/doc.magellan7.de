...
* NEW: `BER-Schul Z 513 – Zeugnis der Fachhochschulreife (zweijährige Fachoberschule) – (4 Seiten) – (12.19)` Eine Anleitung finden Sie [hier](https://doc.la.stueber.de/berichte/zeugnisse/ber/BER-GY%20%28abi_4_berechnungsbogen%29%2805.20%29/), die Datei können Sie vorab [hier](https://my.hidrive.com/share/3pr60tsv6j) herunterladen.
