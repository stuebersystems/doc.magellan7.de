...
![Filtereinstellungen bearbeiten bitte anhaken!](/assets/images/knowledgebase/csv1.png)

Klicken Sie auf `Speichern`! Sollte die Nachfrage erscheinen, ob das Format beibehalten werden soll, bestätigen Sie es bitte. 

![Aktuelles Format beibehalten!](/assets/images/knowledgebase/csv2.png)
...
![Wählen Sie Feld- und Texttrenner!](/assets/images/knowledgebase/csv3.png)
