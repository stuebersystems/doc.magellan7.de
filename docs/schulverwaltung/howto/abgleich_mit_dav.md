...
![Hier wählen Sie den Mandanten und den Zeitraum aus, in den die Daten übertragen werden.](/assets/images/Datenaustausch_mit_magellan/04.png)
...
![ Hier wählen Sie die Daten aus, die nach MAGELLAN übertragen werden.](/assets/images/datenaustausch_mit_magellan/05.png)
