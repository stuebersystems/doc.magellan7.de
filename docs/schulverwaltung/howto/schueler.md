...
| Art                   | Vorgehen                                                                                                                                                                                                                                                                               |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mit Bewerberaufnahme  | Der neue Schüler wird zunächst als Bewerberim Menü `Bewerber` aufgenommen. Im Rahmen eines Bewerberverfahrens wird der Bewerber dann als Schüler übernommen. Bitte lesen Sie dazu das gesonderte Kapitel [Bewerber](https://doc.magellan7.stueber.de/schulverwaltung/howto/bewerber.html)! Der Schritt |
