...
## Registerkarte `Schüler > Merkmale`
...
## Sammelzuweisung für `Daten1`, `Daten 2`, `Daten3`, und `Merkmale`

Sie können für mehrere Schüler oder Bewerber gleichzeitig bestimmte Werte auf den Registerkarten `Daten 1`, `Daten 2`, `Daten 3` und `Merkmale` zuweisen. 
