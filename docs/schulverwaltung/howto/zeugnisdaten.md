...
Wählen Sie die Schüler aus, Sie können dabei die Funktionen [`Sortieren`, `Gruppieren` oder auch `Filtern`](https://doc.magellan7.stueber.de/schulverwaltung/howto/sort-group-filter-search.html) nutzen. Sind die gewünschten Schüler markiert, klicken Sie auf `Weiter`.
