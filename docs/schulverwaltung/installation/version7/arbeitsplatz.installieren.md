...
![Startdialog der Installation](/assets/images/7/setup_start.png)

![Installationart festlegen](/assets/images/7/setup_type.png)
...
![Bitte wählen Sie den Installationstyp Arbeitsplatz aus!](/assets/images/7/setup_type.png)
...
![Willkommen](/assets/images/7/welcome.png)
...
![Wahl zwischen Vollversion und Testlizenz](/assets/images/7/welcome-license-type.png)
...
![Eingabe der Lizenzdaten](/assets/images/7/welcome-enter-license.png)
...
![Wahl der Region](/assets/images/7/welcome-region.png)

Wählen Sie „Entfernte Datenbank“.

![Wahl der Datenbank](/assets/images/7/welcome-database.png)
...
![ Daten für entfernte Datenbank](/assets/images/7/welcome-remote-database.png)
...
![Daten für entfernte Datenordner](/assets/images/7/welcome-remote-datafolder.png)
...
![Einstellungen für Backup und Restore Ihrer Datenbank](/assets/images/7/welcome-remote-backup.png)
...
![Erste Schritte in MAGELLAN](/assets/images/7/Welcome-erste-schritte.png)
...
![Abschluss des Willkommens-Assistenten](/assets/images/7/anmeldung.png)
...
![`C:\ProgramData\Stueber Systems\Magellan 7`](/assets/images/7/installation/programdata.png)
