...
[Beachten Sie bitte die Mindesteingaben für die Statistik!](https://doc.magellan7.stueber.de/schulverwaltung/regionales/berlin/statistik/01.stat.einstieg/)
...
**Beispiel:** Benötigen Sie einen Wert innerhalb von MAGELLAN mehrfach, beispielsweise Sie hätte zwei Bio-Fachzeilen, müssten Sie nur darauf achten, dass beide Zeilen mit dem korrekten Schlüsselwert (in diesem Beispiel erhielten beide Zeilen den Schlüsselwert `151`) markiert werden. Unabhängig von Ihrem erfassten Kürzel würden wir in diesem Fall `BI` als Kürzel in die Statistikdatei übergeben.
