...
## Wichtig: Kürzel-Schlüsseländerungen

An einigen Stelle gehen wir mit den eingegebenen Daten bei der Übergabe auf besondere Weise um, um Ihnen innerhalb von MAGELLAN mehr Möglichkeiten beim Erfassen von Daten zu geben.

Dazu gehören die folgenden Verzeichnisse:

* Fächer (Verzeichnis Fächer)
* Fremdsprachen (Verzeichnis Muttersprachen)
* Verkehrssprache (Verzeichnis Muttersprache)
* Muttersprachen (Verkehrssprach)
...
### Fächer und Fremdsprachen

wird noch ergänzt

### Verkehrssprache und Muttersprache
